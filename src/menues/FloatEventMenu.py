...
from views.FloatEventView import FloatEventView
from views.SigneupCloseView import SigneupCloseView
from models.FloatEventModel import FloatEventModel

class FloatEventMenu(menus.ButtonMenu):
    def __init__(self, bot, day, hour, minute, month, year, discription, data=None):
        ...
        self.data = data
        self.model = FloatEventModel(day, hour, minute, month, year, data, discription)
